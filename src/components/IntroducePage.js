      ...
      <main className="introduce-main">
        <section className="intro-section">
          <div className="intro-content">
            <h1>비전</h1>
            <br />
            <p>저희 어시스타는 <strong>인간의 잠재력을 깨우고 건강한 삶의 미래를 개척하는 피트니스 테크톨로지 선도기업을 지향</strong>합니다.</p>
            <p><strong>'기술 혁신 · 품질 우선 · 사람중심' 을 핵심가치로 삼고,</strong> 모든 사람이 신체적 한계를 넘어</p>
        ...
        <section className="intro-second-section">
          <div className="intro-footer">
            ...
            <div className="intro-footer-text">
              ...
              <br />
              <br />
              <p>주식회사 어시스타 대표이사 <strong>이 주 영</strong></p>
            </div>
          </div>
        </section>
      </main>
